...
public class App {
    public static void main(String[] args) {
        ...
        System.out.flush();
        Equipo miequipo = new Equipo ("Limones", "Torneo la Bombonera", new ArrayList<>());
        miequipo.reporte();
        miequipo.agregarJugador(new JugadorEntrenador("Francisco Zepeda", 'H', "Entrenador Principal", 1000, 8, 1));
