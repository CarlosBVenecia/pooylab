//suma pares o impares n un rango de valores usando una funcion
...
public class _p72_SumaParesImpares {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.print("[P]ares o [I]mpares ? "); pi 0 Character.toUpperCase( obj.next(.charAt(0));
        } while(pi!='P' && pi!='I');
